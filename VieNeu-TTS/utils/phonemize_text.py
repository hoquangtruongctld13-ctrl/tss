...
# Configuration
def _get_phoneme_dict_path():
    if hasattr(sys, '_MEIPASS'):
        return os.path.join(sys._MEIPASS, "utils", "phoneme_dict.json")
    return os.path.join(os.path.dirname(__file__), "phoneme_dict.json")

PHONEME_DICT_PATH = os.getenv('PHONEME_DICT_PATH', _get_phoneme_dict_path())
